		...
		namespace commands
		{
			namespace baseFormComponent
			{
				...
				CodaScriptCommandHandler(SetBFCAIFormAITrainingSkill)
				{
					...
					if (Form == nullptr)
						return false;
					else if (Buffer >= static_cast<CodaScriptNumericDataTypeT>(ActorValues::kActorVal__MAX_Skill) || Buffer < static_cast<CodaScriptNumericDataTypeT>(ActorValues::kActorVal_Armorer))
						return false;
